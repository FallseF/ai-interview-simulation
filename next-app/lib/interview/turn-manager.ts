import type { InterviewMode, Speaker, Phase, TurnState } from "@/types";
...
export class TurnManager {
  ...
  restore(state: TurnState): void {
    ...
    this.waitingForNext = state.waitingForNext;
    this.turnCount = state.turnCount;
    this.interviewerTurns = state.interviewerTurns;
    this.candidateTurns = state.candidateTurns;
    this.lastAISpeaker = state.lastAISpeaker;
  }
}
